...
import type { QTIInputView } from './input-view-instance'
import type { InputCallback } from './input-view'

export interface QTIInputViewAPI {
  //--------------------------------BaseView------------------------------------------------
  requestFocus(
    instance: string | Ref<QTIInputView | undefined>,
  ...
  clearFocus(instance: string | Ref<QTIInputView | undefined>): void
  ...
  requestRootLayout(instance: string | Ref<QTIInputView | undefined>): void

  requestLayout(instance: string | Ref<QTIInputView | undefined>): void
  ...
  forceUpdateRenderNode(instance: string | Ref<QTIInputView | undefined>): void
  ...
  layoutViewManual(instance: string | Ref<QTIInputView | undefined>): void

  blockRootFocus(instance: string | Ref<QTIInputView | undefined>): void

  unBlockRootFocus(instance: string | Ref<QTIInputView | undefined>): void
  ...
  invalidate(instance: string | Ref<QTIInputView | undefined>): void
  ...
  requestAutofocus(instance: string | Ref<QTIInputView | undefined>): void

  //
  hasFocus(instance: string | Ref<QTIInputView | undefined>): Promise<boolean>

  isFocused(instance: string | Ref<QTIInputView | undefined>): Promise<boolean>
...
export function createQTIInputViewAPI(): QTIInputViewAPI {
  //--------------------------------------------------------------------------------
  ...
  function clearFocus(instance: string | Ref<QTIInputView | undefined>) {
    if (isString(instance)) {
  ...
  function requestRootLayout(instance: string | Ref<QTIInputView | undefined>) {
    if (isString(instance)) {
  ...
  function requestLayout(instance: string | Ref<QTIInputView | undefined>) {
    if (isString(instance)) {
  ...
  function invalidate(instance: string | Ref<QTIInputView | undefined>): void {
    if (isString(instance)) {
  ...
  function getEsInfo(
    ...
    if (isString(instance)) {
      callUIFunction(instance, 'getEsInfo', [])
    } else if (isRef(instance)) {
      instance.value?.getEsInfo(callback)
    }
  }
