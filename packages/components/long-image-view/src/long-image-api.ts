...
import type { QTILongImage } from './long-image-instance'
import type { Ref } from '@vue/reactivity'

export interface QtLongImageAPI {
  //---------------------------------Text-----------------------------------------------

  //----------------------------------BaseView----------------------------------------------
  requestFocus(
    instance: string | Ref<QTILongImage | undefined>,
  ...
  clearFocus(instance: string | Ref<QTILongImage | undefined>): void
  ...
  requestRootLayout(instance: string | Ref<QTILongImage | undefined>): void

  requestLayout(instance: string | Ref<QTILongImage | undefined>): void
  ...
  forceUpdateRenderNode(instance: string | Ref<QTILongImage | undefined>): void
  ...
  layoutViewManual(instance: string | Ref<QTILongImage | undefined>): void

  blockRootFocus(instance: string | Ref<QTILongImage | undefined>): void

  unBlockRootFocus(instance: string | Ref<QTILongImage | undefined>): void
  ...
  invalidate(instance: string | Ref<QTILongImage | undefined>): void
  ...
  requestAutofocus(instance: string | Ref<QTILongImage | undefined>): void

  //
  hasFocus(instance: string | Ref<QTILongImage | undefined>): Promise<boolean>

  isFocused(instance: string | Ref<QTILongImage | undefined>): Promise<boolean>
...
export function createQtLongImageAPI(): QtLongImageAPI {
  //--------------------------------------------------------------------------------
  ...
  function clearFocus(instance: string | Ref<QTILongImage | undefined>) {
    if (isString(instance)) {
  ...
  function requestRootLayout(instance: string | Ref<QTILongImage | undefined>) {
    if (isString(instance)) {
  ...
  function requestLayout(instance: string | Ref<QTILongImage | undefined>) {
    if (isString(instance)) {
  ...
  function invalidate(instance: string | Ref<QTILongImage | undefined>): void {
    if (isString(instance)) {
