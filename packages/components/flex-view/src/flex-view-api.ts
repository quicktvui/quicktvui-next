...
import type { QTIFlexView } from './flex-view-instance'

export interface QtFlexViewAPI {
  //--------------------------------------------------------------------------------
  requestFocus(
    instance: string | Ref<QTIFlexView | undefined>,
  ...
  clearFocus(instance: string | Ref<QTIFlexView | undefined>): void
  ...
  requestRootLayout(instance: string | Ref<QTIFlexView | undefined>): void

  requestLayout(instance: string | Ref<QTIFlexView | undefined>): void
  ...
  forceUpdateRenderNode(instance: string | Ref<QTIFlexView | undefined>): void
  ...
  layoutViewManual(instance: string | Ref<QTIFlexView | undefined>): void

  blockRootFocus(instance: string | Ref<QTIFlexView | undefined>): void

  unBlockRootFocus(instance: string | Ref<QTIFlexView | undefined>): void
  ...
  invalidate(instance: string | Ref<QTIFlexView | undefined>): void
  ...
  requestAutofocus(instance: string | Ref<QTIFlexView | undefined>): void

  //
  hasFocus(instance: string | Ref<QTIFlexView | undefined>): Promise<boolean>

  isFocused(instance: string | Ref<QTIFlexView | undefined>): Promise<boolean>
...
export function createQtFlexViewAPI(): QtFlexViewAPI {
  //--------------------------------------------------------------------------------
  ...
  function clearFocus(instance: string | Ref<QTIFlexView | undefined>) {
    if (isString(instance)) {
  ...
  function requestRootLayout(instance: string | Ref<QTIFlexView | undefined>) {
    if (isString(instance)) {
  ...
  function requestLayout(instance: string | Ref<QTIFlexView | undefined>) {
    if (isString(instance)) {
  ...
  function invalidate(instance: string | Ref<QTIFlexView | undefined>): void {
    if (isString(instance)) {
