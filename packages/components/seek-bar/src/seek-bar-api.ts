...
import type { QTISeekBar } from './seek-bar-instance'
import type {
  QTSeekBarGravity,
...
export interface QtSeekBarAPI {
  //-------------------------------BaseView-------------------------------------------------
  requestFocus(
    instance: string | Ref<QTISeekBar | undefined>,
  ...
  clearFocus(instance: string | Ref<QTISeekBar | undefined>): void
  ...
  requestRootLayout(instance: string | Ref<QTISeekBar | undefined>): void

  requestLayout(instance: string | Ref<QTISeekBar | undefined>): void
  ...
  forceUpdateRenderNode(instance: string | Ref<QTISeekBar | undefined>): void
  ...
  layoutViewManual(instance: string | Ref<QTISeekBar | undefined>): void

  blockRootFocus(instance: string | Ref<QTISeekBar | undefined>): void

  unBlockRootFocus(instance: string | Ref<QTISeekBar | undefined>): void
  ...
  invalidate(instance: string | Ref<QTISeekBar | undefined>): void
  ...
  requestAutofocus(instance: string | Ref<QTISeekBar | undefined>): void

  //
  hasFocus(instance: string | Ref<QTISeekBar | undefined>): Promise<boolean>
  ...
  isFocused(instance: Ref<QTISeekBar | undefined>): boolean
  ...
  invalidateSeekBar(instance: string | Ref<QTISeekBar | undefined>): void
  ...
  show(instance: string | Ref<QTISeekBar | undefined>, value: boolean): void
  ...
  getProgress(instance: string | Ref<QTISeekBar | undefined>): void

  getLeftProgress(instance: string | Ref<QTISeekBar | undefined>): void

  getRightProgress(instance: string | Ref<QTISeekBar | undefined>): void
  ...
  scaleThumb(instance: string | Ref<QTISeekBar | undefined>): void

  scaleLeftThumb(instance: string | Ref<QTISeekBar | undefined>): void

  scaleRightThumb(instance: string | Ref<QTISeekBar | undefined>): void

  resetThumb(instance: string | Ref<QTISeekBar | undefined>): void

  resetLeftThumb(instance: string | Ref<QTISeekBar | undefined>): void

  resetRightThumb(instance: string | Ref<QTISeekBar | undefined>): void
  ...
  setThumbUrl(instance: string | Ref<QTISeekBar | undefined>, url: string): void
  ...
  setSteps(instance: string | Ref<QTISeekBar | undefined>, steps: number): void
...
export function createQtSeekBarAPI(): QtSeekBarAPI {
  //--------------------------------------------------------------------------------
  ...
  function clearFocus(instance: string | Ref<QTISeekBar | undefined>) {
    if (isString(instance)) {
  ...
  function requestRootLayout(instance: string | Ref<QTISeekBar | undefined>) {
    if (isString(instance)) {
  ...
  function requestLayout(instance: string | Ref<QTISeekBar | undefined>) {
    if (isString(instance)) {
  ...
  function invalidate(instance: string | Ref<QTISeekBar | undefined>): void {
    if (isString(instance)) {
  ...
  function isFocused(instance: Ref<QTISeekBar | undefined>): boolean {
  ...
  function startSeek(
    instance: Ref<QTISeekBar | undefined>,
    forward: boolean
  ): void {
    instance.value?.startSeek(forward)
  }

  function stopSeek(instance: Ref<QTISeekBar | undefined>): void {
    instance.value?.stopSeek()
  }
  ...
  function invalidateSeekBar(
    ...
    if (isString(instance)) {
      ...
      instance.value?.invalidateSeekBar()
    }
  }
  ...
  function getProgress(instance: string | Ref<QTISeekBar | undefined>): void {
    if (isString(instance)) {
  ...
  function scaleThumb(instance: string | Ref<QTISeekBar | undefined>): void {
    if (isString(instance)) {
  ...
  function resetThumb(instance: string | Ref<QTISeekBar | undefined>): void {
    if (isString(instance)) {
