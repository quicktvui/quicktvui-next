...
import type { QTIColumn } from './column-instance'

export interface QtColumnAPI {
  //--------------------------------BaseView------------------------------------------------
  requestFocus(
    instance: string | Ref<QTIColumn | undefined>,
  ...
  clearFocus(instance: string | Ref<QTIColumn | undefined>): void
  ...
  requestRootLayout(instance: string | Ref<QTIColumn | undefined>): void

  requestLayout(instance: string | Ref<QTIColumn | undefined>): void
  ...
  forceUpdateRenderNode(instance: string | Ref<QTIColumn | undefined>): void
  ...
  layoutViewManual(instance: string | Ref<QTIColumn | undefined>): void

  blockRootFocus(instance: string | Ref<QTIColumn | undefined>): void

  unBlockRootFocus(instance: string | Ref<QTIColumn | undefined>): void
  ...
  invalidate(instance: string | Ref<QTIColumn | undefined>): void
  ...
  requestAutofocus(instance: string | Ref<QTIColumn | undefined>): void

  //
  hasFocus(instance: string | Ref<QTIColumn | undefined>): Promise<boolean>

  isFocused(instance: string | Ref<QTIColumn | undefined>): Promise<boolean>
...
export function createQtColumnAPI(): QtColumnAPI {
  //--------------------------------BaseView------------------------------------------------
  ...
  function clearFocus(instance: string | Ref<QTIColumn | undefined>) {
    if (isString(instance)) {
  ...
  function requestRootLayout(instance: string | Ref<QTIColumn | undefined>) {
    if (isString(instance)) {
  ...
  function requestLayout(instance: string | Ref<QTIColumn | undefined>) {
    if (isString(instance)) {
  ...
  function blockRootFocus(instance: string | Ref<QTIColumn | undefined>): void {
    if (isString(instance)) {
  ...
  function invalidate(instance: string | Ref<QTIColumn | undefined>): void {
    if (isString(instance)) {
