...
import type { QTIPluginView } from './plugin-view-instance'
import type { Ref } from '@vue/reactivity'

export interface QtPluginViewAPI {
  //------------------------------PluginView--------------------------------------------------
  dispatchFunction(
  ...
  clearFocus(instance: string | Ref<QTIPluginView | undefined>): void
  ...
  requestRootLayout(instance: string | Ref<QTIPluginView | undefined>): void

  requestLayout(instance: string | Ref<QTIPluginView | undefined>): void
  ...
  forceUpdateRenderNode(instance: string | Ref<QTIPluginView | undefined>): void
  ...
  layoutViewManual(instance: string | Ref<QTIPluginView | undefined>): void

  blockRootFocus(instance: string | Ref<QTIPluginView | undefined>): void

  unBlockRootFocus(instance: string | Ref<QTIPluginView | undefined>): void
  ...
  invalidate(instance: string | Ref<QTIPluginView | undefined>): void
  ...
  requestAutofocus(instance: string | Ref<QTIPluginView | undefined>): void

  //
  hasFocus(instance: string | Ref<QTIPluginView | undefined>): Promise<boolean>

  isFocused(instance: string | Ref<QTIPluginView | undefined>): Promise<boolean>
...
export function createQtPluginViewAPI(): QtPluginViewAPI {
  //--------------------------------------------------------------------------------
  function dispatchFunction(
    ...
    if (isString(instance)) {
      return callUIFunctionWithPromise(instance, funName, params)
  ...
  function clearFocus(instance: string | Ref<QTIPluginView | undefined>) {
    if (isString(instance)) {
  ...
  function requestLayout(instance: string | Ref<QTIPluginView | undefined>) {
    if (isString(instance)) {
  ...
  function invalidate(instance: string | Ref<QTIPluginView | undefined>): void {
    if (isString(instance)) {
