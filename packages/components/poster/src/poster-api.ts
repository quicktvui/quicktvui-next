...
import type { QTIPoster } from './poster-instance'

export interface QtPosterAPI {
  //--------------------------------BaseView------------------------------------------------
  requestFocus(
    instance: string | Ref<QTIPoster | undefined>,
  ...
  clearFocus(instance: string | Ref<QTIPoster | undefined>): void
  ...
  requestRootLayout(instance: string | Ref<QTIPoster | undefined>): void

  requestLayout(instance: string | Ref<QTIPoster | undefined>): void
  ...
  forceUpdateRenderNode(instance: string | Ref<QTIPoster | undefined>): void
  ...
  layoutViewManual(instance: string | Ref<QTIPoster | undefined>): void

  blockRootFocus(instance: string | Ref<QTIPoster | undefined>): void

  unBlockRootFocus(instance: string | Ref<QTIPoster | undefined>): void
  ...
  invalidate(instance: string | Ref<QTIPoster | undefined>): void
  ...
  requestAutofocus(instance: string | Ref<QTIPoster | undefined>): void

  //
  hasFocus(instance: string | Ref<QTIPoster | undefined>): Promise<boolean>

  isFocused(instance: string | Ref<QTIPoster | undefined>): Promise<boolean>
...
export function createQtPosterAPI(): QtPosterAPI {
  //--------------------------------BaseView------------------------------------------------
  ...
  function clearFocus(instance: string | Ref<QTIPoster | undefined>) {
    if (isString(instance)) {
  ...
  function requestRootLayout(instance: string | Ref<QTIPoster | undefined>) {
    if (isString(instance)) {
  ...
  function requestLayout(instance: string | Ref<QTIPoster | undefined>) {
    if (isString(instance)) {
  ...
  function blockRootFocus(instance: string | Ref<QTIPoster | undefined>): void {
    if (isString(instance)) {
  ...
  function invalidate(instance: string | Ref<QTIPoster | undefined>): void {
    if (isString(instance)) {
