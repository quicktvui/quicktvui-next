...
import type { QTISurfaceView } from './surface-view-instance'

export interface QtSurfaceViewAPI {
  //-------------------------------BaseView-------------------------------------------------
  requestFocus(
    instance: string | Ref<QTISurfaceView | undefined>,
  ...
  clearFocus(instance: string | Ref<QTISurfaceView | undefined>): void
  ...
  requestRootLayout(instance: string | Ref<QTISurfaceView | undefined>): void

  requestLayout(instance: string | Ref<QTISurfaceView | undefined>): void
  ...
  layoutViewManual(instance: string | Ref<QTISurfaceView | undefined>): void

  blockRootFocus(instance: string | Ref<QTISurfaceView | undefined>): void

  unBlockRootFocus(instance: string | Ref<QTISurfaceView | undefined>): void
  ...
  invalidate(instance: string | Ref<QTISurfaceView | undefined>): void
  ...
  requestAutofocus(instance: string | Ref<QTISurfaceView | undefined>): void

  //
  hasFocus(instance: string | Ref<QTISurfaceView | undefined>): Promise<boolean>
...
export function createQtSurfaceViewAPI(): QtSurfaceViewAPI {
  //--------------------------------------------------------------------------------
  ...
  function clearFocus(instance: string | Ref<QTISurfaceView | undefined>) {
    if (isString(instance)) {
  ...
  function requestLayout(instance: string | Ref<QTISurfaceView | undefined>) {
    if (isString(instance)) {
