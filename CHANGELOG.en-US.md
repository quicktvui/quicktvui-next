...
- Project adding cypress into QuickTVUI (#5281 by @JeremyWuuuuu)
...
- Docs replace @quicktvui/icons with @element-plus/icons-vue (#4704 by @pdsuwwz)
...
- Dev play add @quicktvui/icons (#4034 by @xiaoxian521)
