<template>
  <div class="es-sdk-root-css">
    <div class="es-sdk-content-row-css">
      ...
      <s-text-button
        text="展开第三个"
        @onButtonClicked="onThreeButtonClicked"
      />
      <s-text-button text="展开第四个" @onButtonClicked="onFourButtonClicked" />
      <s-text-button
        text="调用第一个Item的方法"
        @onButtonClicked="onCallButtonClicked"
      />
    </div>
    <qt-collapse
      ref="collapseRef"
    ...
    >
      <qt-collapse-item-green
        @onCollapseItemGreenExpand="onCollapseItemGreenExpand"
      />
...
import type { QTGreenCollapseItem } from './item/QTGreenCollapseItem'
import type {
  QTCollapse,
  QTCollapseItem,
  QTICollapse,
