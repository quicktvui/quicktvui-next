...
Hi! 首先感谢你使用 QuickTVUI。

QuickTVUI 是一套为开发者、设计师和产品经理准备的开源组件库，旨在快速搭建页面。它基于 Vue 3 开发，并提供了配套的设计资源，充分满足可定制化的需求。

QuickTVUI 的成长离不开大家的支持，如果你愿意为 QuickTVUI 贡献代码或提供建议，请阅读以下内容。
...
- 请说明 QuickTVUI 和 Vue 的版本号，并提供操作系统和浏览器信息。推荐使用 [Playground](https://element-plus.run/) 生成在线 demo，这能够更直观地重现问题。
