...
import type { QTITransitionImg } from './transition-img-instance'

export interface QtTransitionImgAPI {
  //-------------------------------------TransitionImg-------------------------------------------
  setNextColor(
    instance: string | Ref<QTITransitionImg | undefined>,
    color: string | number
  ): void
  ...
  clearFocus(instance: string | Ref<QTITransitionImg | undefined>): void
  ...
  requestRootLayout(instance: string | Ref<QTITransitionImg | undefined>): void

  requestLayout(instance: string | Ref<QTITransitionImg | undefined>): void
  ...
  layoutViewManual(instance: string | Ref<QTITransitionImg | undefined>): void

  blockRootFocus(instance: string | Ref<QTITransitionImg | undefined>): void

  unBlockRootFocus(instance: string | Ref<QTITransitionImg | undefined>): void
  ...
  invalidate(instance: string | Ref<QTITransitionImg | undefined>): void
  ...
  requestAutofocus(instance: string | Ref<QTITransitionImg | undefined>): void
...
export function createQtTransitionImgAPI(): QtTransitionImgAPI {
  function setNextColor(
    instance: string | Ref<QTITransitionImg | undefined>,
    color: string | number
  ): void {
    if (isString(instance)) {
      callUIFunction(instance, 'setNextColor', [color])
    } else if (isRef(instance)) {
      instance.value?.setNextColor(color)
    }
  }
  ...
  function setNextImage(
    ...
    if (isString(instance)) {
      callUIFunction(instance, 'setNextImage', [url])
    } else if (isRef(instance)) {
      instance.value?.setNextImage(url)
    }
  }
  ...
  function setTransitionTime(
    ...
    if (isString(instance)) {
      callUIFunction(instance, 'setTransitionTime', [duration])
    } else if (isRef(instance)) {
      instance.value?.setTransitionTime(duration)
    }
  }
  ...
  function clearFocus(instance: string | Ref<QTITransitionImg | undefined>) {
    if (isString(instance)) {
  ...
  function requestLayout(instance: string | Ref<QTITransitionImg | undefined>) {
    if (isString(instance)) {
