...
export default function (viewRef: Ref) {
  ...
  function scrollToPosition(position: number, offset?: number): void {
    if (viewRef.value) {
      Native.callUIFunction(viewRef.value, 'scrollToPosition', [
        position,
        offset,
      ])
    }
  ...
  function updateItemTraverse(
    ...
    if (viewRef.value) {
      Native.callUIFunction(viewRef.value, 'updateItemTraverse', [
        position,
        data,
        traverse,
      ])
  ...
  function updateItemRange(
    ...
    if (viewRef.value) {
      Native.callUIFunction(viewRef.value, 'updateItemRange', [
        position,
        count,
        itemList,
      ])
  ...
  function insertItemRange(
    ...
    if (viewRef.value) {
      Native.callUIFunction(viewRef.value, 'insertItemRange', [
        position,
        itemList,
      ])
    }
  ...
  function addListDataWithParams(
    ...
    if (viewRef.value) {
      Native.callUIFunction(viewRef.value, 'addListDataWithParams', [
        itemList,
        deleteCount,
      ])
    }
  ...
  function updateItem(position: number, data: QTListViewItem): void {
    if (viewRef.value) {
