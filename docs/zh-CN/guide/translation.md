...
In this chapter, we will discuss how to help translating the documentation of QuickTVUI.
...
2. Go to [QuickTVUI](https://crowdin.com/project/element-plus) project.
