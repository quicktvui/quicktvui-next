...
import type { QTIText } from './text-instance'
import type { Ref } from '@vue/reactivity'
import type { QTTextSpan } from './text-types'

export interface QtTextAPI {
  //---------------------------------Text-----------------------------------------------
  ...
  //----------------------------------BaseView----------------------------------------------
  requestFocus(
    instance: string | Ref<QTIText | undefined>,
  ...
  clearFocus(instance: string | Ref<QTIText | undefined>): void
  ...
  requestRootLayout(instance: string | Ref<QTIText | undefined>): void

  requestLayout(instance: string | Ref<QTIText | undefined>): void
  ...
  forceUpdateRenderNode(instance: string | Ref<QTIText | undefined>): void
  ...
  layoutViewManual(instance: string | Ref<QTIText | undefined>): void

  blockRootFocus(instance: string | Ref<QTIText | undefined>): void

  unBlockRootFocus(instance: string | Ref<QTIText | undefined>): void

  changeAlpha(instance: string | Ref<QTIText | undefined>, alpha: number): void
  ...
  invalidate(instance: string | Ref<QTIText | undefined>): void
  ...
  requestAutofocus(instance: string | Ref<QTIText | undefined>): void

  //
  hasFocus(instance: string | Ref<QTIText | undefined>): Promise<boolean>

  isFocused(instance: string | Ref<QTIText | undefined>): Promise<boolean>
...
export function createQtTextAPI(): QtTextAPI {
  function setText(
    instance: string | Ref<QTIText | undefined>,
    text: string
  ): void {
    if (isString(instance)) {
      callUIFunction(instance, 'setText', [text])
  ...
  function setTextSize(
    ...
    if (isString(instance)) {
      callUIFunction(instance, 'setTextSize', [size])
    } else if (isRef(instance)) {
  ...
  function setTextColor(
    ...
    if (isString(instance)) {
      callUIFunction(instance, 'setTextColor', [color])
    } else if (isRef(instance)) {
  ...
  function textSpan(
    ...
    if (isString(instance)) {
      callUIFunction(instance, 'textSpan', [span])
    } else if (isRef(instance)) {
  ...
  function clearFocus(instance: string | Ref<QTIText | undefined>) {
    if (isString(instance)) {
  ...
  function requestRootLayout(instance: string | Ref<QTIText | undefined>) {
    if (isString(instance)) {
  ...
  function requestLayout(instance: string | Ref<QTIText | undefined>) {
    if (isString(instance)) {
  ...
  function layoutViewManual(instance: string | Ref<QTIText | undefined>): void {
    if (isString(instance)) {
  ...
  function blockRootFocus(instance: string | Ref<QTIText | undefined>): void {
    if (isString(instance)) {
  ...
  function unBlockRootFocus(instance: string | Ref<QTIText | undefined>): void {
    if (isString(instance)) {
  ...
  function invalidate(instance: string | Ref<QTIText | undefined>): void {
    if (isString(instance)) {
  ...
  function requestAutofocus(instance: string | Ref<QTIText | undefined>): void {
    if (isString(instance)) {
