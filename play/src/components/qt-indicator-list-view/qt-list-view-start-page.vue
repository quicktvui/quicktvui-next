  ...
  <qt-view class="es-sdk-root-css">
    ...
    <qt-view class="quick-list-view">
      <qt-view class="list_view_row">
        <qt-list-view class="list_view" ref="listViewRef" :clipChildren="false" :clipPadding="false"
          ...
          <tv-item
            ...
            <div duplicateParentState showOnState="focused"
                 style="position: absolute;top: -5px;left: -5px;right: -5px;bottom: -5px; background-color: transparent;
                border-color: white;border-radius: 9px;border-width: 3px;border-style: solid"/>
            <div flexStyle="${style}"
                 :clipChildren="true"
                 :focusable="true"
        ...
        <qt-list-view class="list_view" ref="listViewRefCenter" :clipChildren="false" :clipPadding="false"
                      @item-click="onItemClick"
                      @item-bind="onItemBind" horizontal :padding="'0,0,30,0'" :defaultFocus="defaultFocus"
                      :blockFocusDirections="['left','right']">
          <!-- item -->
        ...
        <qt-list-view class="list_view" ref="cmdListViewRef" :clipChildren="false" :clipPadding="false"
                      @item-click="onItemClick"
                      @item-bind="onItemBind" horizontal :padding="'0,0,30,0'" :defaultFocus="defaultFocus"
                      :blockFocusDirections="['left','right']">
          <!-- item -->
...
import {QTIndicatorListView, QTListViewItem, QTPoster} from "quicktvui";
...
export default defineComponent({
  ...
  setup: function() {
    ...
    function onPageIndexFunction(e) {
      toast.showToast('----->' + e.currentIndex + '------->' + JSON.stringify(e.currentList.image) + e.currentList.type)
    }
