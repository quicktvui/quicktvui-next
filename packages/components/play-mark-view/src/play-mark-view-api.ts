...
import type { QTIPlayMarkView } from './play-mark-view-instance'

export interface QtPlayMarkViewAPI {
  //-----------------------------------BaseView---------------------------------------------
  requestFocus(
    instance: string | Ref<QTIPlayMarkView | undefined>,
  ...
  clearFocus(instance: string | Ref<QTIPlayMarkView | undefined>): void
  ...
  requestRootLayout(instance: string | Ref<QTIPlayMarkView | undefined>): void

  requestLayout(instance: string | Ref<QTIPlayMarkView | undefined>): void
  ...
  layoutViewManual(instance: string | Ref<QTIPlayMarkView | undefined>): void

  blockRootFocus(instance: string | Ref<QTIPlayMarkView | undefined>): void

  unBlockRootFocus(instance: string | Ref<QTIPlayMarkView | undefined>): void
  ...
  invalidate(instance: string | Ref<QTIPlayMarkView | undefined>): void
  ...
  requestAutofocus(instance: string | Ref<QTIPlayMarkView | undefined>): void
...
export function createQtPlayMarkViewAPI(): QtPlayMarkViewAPI {
  //--------------------------------------------------------------------------------
  ...
  function clearFocus(instance: string | Ref<QTIPlayMarkView | undefined>) {
    if (isString(instance)) {
  ...
  function requestLayout(instance: string | Ref<QTIPlayMarkView | undefined>) {
    if (isString(instance)) {
