...
import type { QTIRippleView } from './ripple-view-instance'

export interface QtRippleViewAPI {
  //--------------------------------------BaseView------------------------------------------
  requestFocus(
    instance: string | Ref<QTIRippleView | undefined>,
  ...
  clearFocus(instance: string | Ref<QTIRippleView | undefined>): void
  ...
  requestRootLayout(instance: string | Ref<QTIRippleView | undefined>): void

  requestLayout(instance: string | Ref<QTIRippleView | undefined>): void
  ...
  forceUpdateRenderNode(instance: string | Ref<QTIRippleView | undefined>): void
  ...
  layoutViewManual(instance: string | Ref<QTIRippleView | undefined>): void

  blockRootFocus(instance: string | Ref<QTIRippleView | undefined>): void

  unBlockRootFocus(instance: string | Ref<QTIRippleView | undefined>): void
  ...
  invalidate(instance: string | Ref<QTIRippleView | undefined>): void
  ...
  requestAutofocus(instance: string | Ref<QTIRippleView | undefined>): void

  //
  hasFocus(instance: string | Ref<QTIRippleView | undefined>): Promise<boolean>

  isFocused(instance: string | Ref<QTIRippleView | undefined>): Promise<boolean>
...
export function createQtRippleViewAPI(): QtRippleViewAPI {
  //--------------------------------------------------------------------------------
  ...
  function clearFocus(instance: string | Ref<QTIRippleView | undefined>) {
    if (isString(instance)) {
  ...
  function requestLayout(instance: string | Ref<QTIRippleView | undefined>) {
    if (isString(instance)) {
  ...
  function invalidate(instance: string | Ref<QTIRippleView | undefined>): void {
    if (isString(instance)) {
