...
import type { QTISwiperSlide } from './swiper-slide-instance'

export interface QtSwiperSlideAPI {
  //---------------------------------SwiftSlide-----------------------------------
  doAnimation(
    instance: string | Ref<QTISwiperSlide | undefined>,
    fromX: string,
    toX: string,
    fromY: string,
    toY: string,
  ...
  clearFocus(instance: string | Ref<QTISwiperSlide | undefined>): void
  ...
  requestRootLayout(instance: string | Ref<QTISwiperSlide | undefined>): void

  requestLayout(instance: string | Ref<QTISwiperSlide | undefined>): void
  ...
  layoutViewManual(instance: string | Ref<QTISwiperSlide | undefined>): void

  blockRootFocus(instance: string | Ref<QTISwiperSlide | undefined>): void

  unBlockRootFocus(instance: string | Ref<QTISwiperSlide | undefined>): void
  ...
  invalidate(instance: string | Ref<QTISwiperSlide | undefined>): void
  ...
  requestAutofocus(instance: string | Ref<QTISwiperSlide | undefined>): void

  //
  hasFocus(instance: string | Ref<QTISwiperSlide | undefined>): Promise<boolean>
...
export function createQtSwiperSlideAPI(): QtSwiperSlideAPI {
  function doAnimation(
    ...
    if (isString(instance)) {
      callUIFunction(instance, 'doAnimation', [
        fromX,
        toX,
        fromY,
        toY,
  ...
  function clearFocus(instance: string | Ref<QTISwiperSlide | undefined>) {
    if (isString(instance)) {
  ...
  function requestLayout(instance: string | Ref<QTISwiperSlide | undefined>) {
    if (isString(instance)) {
