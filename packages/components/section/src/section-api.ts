...
import type { QTIVueSection } from './section-instance'

export interface QtSectionAPI {
  //------------------------------BaseView--------------------------------------------------
  requestFocus(
    instance: string | Ref<QTIVueSection | undefined>,
  ...
  clearFocus(instance: string | Ref<QTIVueSection | undefined>): void
  ...
  requestRootLayout(instance: string | Ref<QTIVueSection | undefined>): void

  requestLayout(instance: string | Ref<QTIVueSection | undefined>): void
  ...
  forceUpdateRenderNode(instance: string | Ref<QTIVueSection | undefined>): void
  ...
  layoutViewManual(instance: string | Ref<QTIVueSection | undefined>): void

  blockRootFocus(instance: string | Ref<QTIVueSection | undefined>): void

  unBlockRootFocus(instance: string | Ref<QTIVueSection | undefined>): void
  ...
  invalidate(instance: string | Ref<QTIVueSection | undefined>): void
  ...
  requestAutofocus(instance: string | Ref<QTIVueSection | undefined>): void

  //
  hasFocus(instance: string | Ref<QTIVueSection | undefined>): Promise<boolean>

  isFocused(instance: string | Ref<QTIVueSection | undefined>): Promise<boolean>
...
export function createQtSectionAPI(): QtSectionAPI {
  //--------------------------------------------------------------------------------
  ...
  function clearFocus(instance: string | Ref<QTIVueSection | undefined>) {
    if (isString(instance)) {
  ...
  function requestLayout(instance: string | Ref<QTIVueSection | undefined>) {
    if (isString(instance)) {
  ...
  function invalidate(instance: string | Ref<QTIVueSection | undefined>): void {
    if (isString(instance)) {
