...
import type { QTIRow } from './row-instance'

export interface QtRowAPI {
  //--------------------------------BaseView------------------------------------------------
  requestFocus(
    instance: string | Ref<QTIRow | undefined>,
  ...
  clearFocus(instance: string | Ref<QTIRow | undefined>): void
  ...
  requestRootLayout(instance: string | Ref<QTIRow | undefined>): void

  requestLayout(instance: string | Ref<QTIRow | undefined>): void
  ...
  forceUpdateRenderNode(instance: string | Ref<QTIRow | undefined>): void
  ...
  layoutViewManual(instance: string | Ref<QTIRow | undefined>): void

  blockRootFocus(instance: string | Ref<QTIRow | undefined>): void

  unBlockRootFocus(instance: string | Ref<QTIRow | undefined>): void

  changeAlpha(instance: string | Ref<QTIRow | undefined>, alpha: number): void
  ...
  invalidate(instance: string | Ref<QTIRow | undefined>): void
  ...
  requestAutofocus(instance: string | Ref<QTIRow | undefined>): void

  //
  hasFocus(instance: string | Ref<QTIRow | undefined>): Promise<boolean>

  isFocused(instance: string | Ref<QTIRow | undefined>): Promise<boolean>

  getLocationOnScreen(
    instance: string | Ref<QTIRow | undefined>
  ): Promise<QTEventData<QTLocation>>

  getViewState(instance: string | Ref<QTIRow | undefined>): Promise<QTViewState>
...
export function createQtRowAPI(): QtRowAPI {
  //--------------------------------BaseView------------------------------------------------
  ...
  function clearFocus(instance: string | Ref<QTIRow | undefined>) {
    if (isString(instance)) {
  ...
  function requestRootLayout(instance: string | Ref<QTIRow | undefined>) {
    if (isString(instance)) {
  ...
  function requestLayout(instance: string | Ref<QTIRow | undefined>) {
    if (isString(instance)) {
  ...
  function layoutViewManual(instance: string | Ref<QTIRow | undefined>): void {
    if (isString(instance)) {
  ...
  function blockRootFocus(instance: string | Ref<QTIRow | undefined>): void {
    if (isString(instance)) {
  ...
  function unBlockRootFocus(instance: string | Ref<QTIRow | undefined>): void {
    if (isString(instance)) {
  ...
  function invalidate(instance: string | Ref<QTIRow | undefined>): void {
    if (isString(instance)) {
  ...
  function requestAutofocus(instance: string | Ref<QTIRow | undefined>): void {
    if (isString(instance)) {
