...
export default function (viewRef: Ref) {
  function dispatchFunctionBySid(
    sid: string,
    funcName: string,
    args: Array<QTNativeParams>
  ): void {
    if (viewRef.value) {
      Native.callUIFunction(viewRef.value, 'dispatchFunctionBySid', [
        sid,
        funcName,
        args,
      ])
  ...
  function requestChildFocus(
    ...
    if (viewRef.value) {
      Native.callUIFunction(viewRef.value, 'requestChildFocus', [
        position,
        direction,
      ])
    }
  ...
  function setVisibility(v: QTVisibility): void {
    if (viewRef.value) {
  ...
  function setDescendantFocusability(descendant: QTFocusDescendant): void {
    if (viewRef.value) {
      Native.callUIFunction(viewRef.value, 'setDescendantFocusability', [
        descendant,
      ])
    }
  }
  ...
  function changeDescendantFocusability(
    ...
    if (viewRef.value) {
      Native.callUIFunction(viewRef.value, 'changeDescendantFocusability', [
        descendant,
      ])
    }
  }
  ...
  function updateLayout(
    ...
    if (viewRef.value) {
      Native.callUIFunction(viewRef.value, 'updateLayout', [
        width,
        height,
        x,
        y,
  ...
  function dispatchFunctionForTarget(
    ...
    if (viewRef.value) {
      Native.callUIFunction(viewRef.value, 'dispatchFunctionForTarget', [
        targetName,
        functionTargetName,
        params,
        delay,
  ...
  function setBlockFocusDirections(
    ...
    if (viewRef.value) {
      Native.callUIFunction(viewRef.value, 'setBlockFocusDirections', [
        directionList,
      ])
    }
  }
  ...
  function requestChildFocusAtIndex(position: number): void {
    if (viewRef.value) {
      Native.callUIFunction(viewRef.value, 'requestChildFocusAtIndex', [
        position,
      ])
    }
  }
