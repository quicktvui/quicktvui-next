...
import type { QTIQRCode } from './qr-code-instance'

export interface QtQRCodeAPI {
  //----------------------------BaseView----------------------------------------------------
  requestFocus(
    instance: string | Ref<QTIQRCode | undefined>,
  ...
  clearFocus(instance: string | Ref<QTIQRCode | undefined>): void
  ...
  requestRootLayout(instance: string | Ref<QTIQRCode | undefined>): void

  requestLayout(instance: string | Ref<QTIQRCode | undefined>): void
  ...
  forceUpdateRenderNode(instance: string | Ref<QTIQRCode | undefined>): void
  ...
  layoutViewManual(instance: string | Ref<QTIQRCode | undefined>): void

  blockRootFocus(instance: string | Ref<QTIQRCode | undefined>): void

  unBlockRootFocus(instance: string | Ref<QTIQRCode | undefined>): void
  ...
  invalidate(instance: string | Ref<QTIQRCode | undefined>): void
  ...
  requestAutofocus(instance: string | Ref<QTIQRCode | undefined>): void

  //
  hasFocus(instance: string | Ref<QTIQRCode | undefined>): Promise<boolean>

  isFocused(instance: string | Ref<QTIQRCode | undefined>): Promise<boolean>
...
export function createQtQRCodeAPI(): QtQRCodeAPI {
  //--------------------------------------------------------------------------------
  ...
  function clearFocus(instance: string | Ref<QTIQRCode | undefined>) {
    if (isString(instance)) {
  ...
  function requestRootLayout(instance: string | Ref<QTIQRCode | undefined>) {
    if (isString(instance)) {
  ...
  function requestLayout(instance: string | Ref<QTIQRCode | undefined>) {
    if (isString(instance)) {
  ...
  function blockRootFocus(instance: string | Ref<QTIQRCode | undefined>): void {
    if (isString(instance)) {
  ...
  function invalidate(instance: string | Ref<QTIQRCode | undefined>): void {
    if (isString(instance)) {
