...
import type { QTIAppIcon } from './app-icon-instance'
import type { Ref } from '@vue/reactivity'

export interface QtAppIconAPI {
  setPackageName(
  ...
  clearFocus(instance: string | Ref<QTIAppIcon | undefined>): void
  ...
  requestRootLayout(instance: string | Ref<QTIAppIcon | undefined>): void

  requestLayout(instance: string | Ref<QTIAppIcon | undefined>): void
  ...
  forceUpdateRenderNode(instance: string | Ref<QTIAppIcon | undefined>): void
  ...
  layoutViewManual(instance: string | Ref<QTIAppIcon | undefined>): void

  blockRootFocus(instance: string | Ref<QTIAppIcon | undefined>): void

  unBlockRootFocus(instance: string | Ref<QTIAppIcon | undefined>): void
  ...
  invalidate(instance: string | Ref<QTIAppIcon | undefined>): void
  ...
  requestAutofocus(instance: string | Ref<QTIAppIcon | undefined>): void

  //
  hasFocus(instance: string | Ref<QTIAppIcon | undefined>): Promise<boolean>

  isFocused(instance: string | Ref<QTIAppIcon | undefined>): Promise<boolean>
...
export function createQtAppIconAPI(): QtAppIconAPI {
  //----------------------------------------------------------------------
  function setPackageName(
    ...
    if (isString(instance)) {
      callUIFunction(instance, 'setPackageName', [packageName])
  ...
  function setRoundingRadius(
    ...
    if (isString(instance)) {
      callUIFunction(instance, 'setRoundingRadius', [roundingRadius])
    } else if (isRef(instance)) {
  ...
  function clearFocus(instance: string | Ref<QTIAppIcon | undefined>) {
    if (isString(instance)) {
  ...
  function requestRootLayout(instance: string | Ref<QTIAppIcon | undefined>) {
    if (isString(instance)) {
  ...
  function requestLayout(instance: string | Ref<QTIAppIcon | undefined>) {
    if (isString(instance)) {
  ...
  function invalidate(instance: string | Ref<QTIAppIcon | undefined>): void {
    if (isString(instance)) {
