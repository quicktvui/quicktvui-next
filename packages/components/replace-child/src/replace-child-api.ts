...
import type { QTIReplaceChildView } from './replace-child-instance'
import type { Ref } from '@vue/reactivity'

export interface QtReplaceChildViewAPI {
  //-----------------------------------ReplaceChildView------------------------------
  setChildSID(
    instance: string | Ref<QTIReplaceChildView | undefined>,
    sid: string
  ): void
  ...
  clearFocus(instance: string | Ref<QTIReplaceChildView | undefined>): void
  ...
  requestLayout(instance: string | Ref<QTIReplaceChildView | undefined>): void
  ...
  blockRootFocus(instance: string | Ref<QTIReplaceChildView | undefined>): void
  ...
  invalidate(instance: string | Ref<QTIReplaceChildView | undefined>): void
...
export function createQtReplaceChildViewAPI(): QtReplaceChildViewAPI {
  function setChildSID(
    instance: string | Ref<QTIReplaceChildView | undefined>,
    sid: string
  ): void {
    if (isString(instance)) {
      callUIFunction(instance, 'setChildSID', [sid])
  ...
  function clearFocus(instance: string | Ref<QTIReplaceChildView | undefined>) {
    if (isString(instance)) {
