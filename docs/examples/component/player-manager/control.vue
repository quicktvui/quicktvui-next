...
import type { ESMediaSource } from '@extscreen/es3-player'
...
export default defineComponent({
  ...
  setup() {
    ...
    function onPlayerPlayMediaSource(mediaSource: ESMediaSource) {
      ...
      playingMediaSourceIndex.value =
        playerManager.value?.getPlayingMediaSourceIndex() ?? -1
    }
