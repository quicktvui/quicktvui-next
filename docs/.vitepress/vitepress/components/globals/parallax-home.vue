...
import HomeApps from '../home/home-apps.vue'
  ...
  <div ref="target" class="home-page">
    <div class="banner" text="center">
      <img
        ...
        src="/cooperation/content-background.png"
      />
      <div class="banner-desc">
        <h1 class="banner-desc1">{{ homeLang['title'] }}</h1>
        <h1>基于 Vue3 电视快应用开发框架</h1>
    ...
    <!--            @click="jumpTo('guide/basic/quick-start.html')"-->
    <!--          />-->
