...
QuickTVUI uses BEM-styled CSS so that you can override styles easily. But if
...
If your project also uses SCSS, you can directly change QuickTVUI style variables. Create a new style file, e.g. `styles/element/index.scss`:
