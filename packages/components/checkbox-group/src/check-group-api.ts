...
import type { QTCheckboxGroup } from './check-box-instance'
import type { Ref } from '@vue/reactivity'

export interface QtCheckboxAPI {
  //---------------------------------Text-----------------------------------------------

  testApi(instance: string | Ref<QTCheckboxGroup | undefined>): void

  selectAll(instance: string | Ref<QTCheckboxGroup | undefined>): void

  cancelAll(instance: string | Ref<QTCheckboxGroup | undefined>): void

  //----------------------------------BaseView----------------------------------------------
  requestFocus(
    instance: string | Ref<QTCheckboxGroup | undefined>,
  ...
  clearFocus(instance: string | Ref<QTCheckboxGroup | undefined>): void
  ...
  requestRootLayout(instance: string | Ref<QTCheckboxGroup | undefined>): void

  requestLayout(instance: string | Ref<QTCheckboxGroup | undefined>): void
  ...
  layoutViewManual(instance: string | Ref<QTCheckboxGroup | undefined>): void

  blockRootFocus(instance: string | Ref<QTCheckboxGroup | undefined>): void

  unBlockRootFocus(instance: string | Ref<QTCheckboxGroup | undefined>): void
  ...
  invalidate(instance: string | Ref<QTCheckboxGroup | undefined>): void
  ...
  requestAutofocus(instance: string | Ref<QTCheckboxGroup | undefined>): void
...
export function createQtCheckboxAPI(): QtCheckboxAPI {
  //--------------------------------------------------------------------------------
  ...
  function clearFocus(instance: string | Ref<QTCheckboxGroup | undefined>) {
    if (isString(instance)) {
  ...
  function requestLayout(instance: string | Ref<QTCheckboxGroup | undefined>) {
    if (isString(instance)) {
  ...
  function testApi(instance: string | Ref<QTCheckboxGroup | undefined>): void {
    if (isString(instance)) {
      callUIFunction(instance, 'testApi', [])
    } else if (isRef(instance)) {
      instance.value?.testApi()
    }
  }
  ...
  function selectAll(
    ...
    if (isString(instance)) {
      callUIFunction(instance, 'selectAll', [])
    } else if (isRef(instance)) {
