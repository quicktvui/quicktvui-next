...
import type { QTILoadingView } from './loading-view-instance'

export interface QtLoadingViewAPI {
  //----------------------------------BaseView----------------------------------------------
  requestFocus(
    instance: string | Ref<QTILoadingView | undefined>,
  ...
  clearFocus(instance: string | Ref<QTILoadingView | undefined>): void
  ...
  requestRootLayout(instance: string | Ref<QTILoadingView | undefined>): void

  requestLayout(instance: string | Ref<QTILoadingView | undefined>): void
  ...
  layoutViewManual(instance: string | Ref<QTILoadingView | undefined>): void

  blockRootFocus(instance: string | Ref<QTILoadingView | undefined>): void

  unBlockRootFocus(instance: string | Ref<QTILoadingView | undefined>): void
  ...
  invalidate(instance: string | Ref<QTILoadingView | undefined>): void
  ...
  requestAutofocus(instance: string | Ref<QTILoadingView | undefined>): void

  //
  hasFocus(instance: string | Ref<QTILoadingView | undefined>): Promise<boolean>
...
export function createQtLoadingViewAPI(): QtLoadingViewAPI {
  //--------------------------------------------------------------------------------
  ...
  function clearFocus(instance: string | Ref<QTILoadingView | undefined>) {
    if (isString(instance)) {
  ...
  function requestLayout(instance: string | Ref<QTILoadingView | undefined>) {
    if (isString(instance)) {
