...
import type { QTRatingBar } from './rating-bar-instance'
import type { Ref } from '@vue/reactivity'

export interface QtRatingBarAPI {
  //---------------------------------Text-----------------------------------------------

  setStarMark(
    instance: string | Ref<QTRatingBar | undefined>,
    mark: string | number
  ): void
  ...
  clearFocus(instance: string | Ref<QTRatingBar | undefined>): void
  ...
  requestRootLayout(instance: string | Ref<QTRatingBar | undefined>): void

  requestLayout(instance: string | Ref<QTRatingBar | undefined>): void
  ...
  forceUpdateRenderNode(instance: string | Ref<QTRatingBar | undefined>): void
  ...
  layoutViewManual(instance: string | Ref<QTRatingBar | undefined>): void

  blockRootFocus(instance: string | Ref<QTRatingBar | undefined>): void

  unBlockRootFocus(instance: string | Ref<QTRatingBar | undefined>): void
  ...
  invalidate(instance: string | Ref<QTRatingBar | undefined>): void
  ...
  requestAutofocus(instance: string | Ref<QTRatingBar | undefined>): void

  //
  hasFocus(instance: string | Ref<QTRatingBar | undefined>): Promise<boolean>

  isFocused(instance: string | Ref<QTRatingBar | undefined>): Promise<boolean>
...
export function createQtRatingBarAPI(): QtRatingBarAPI {
  //--------------------------------------------------------------------------------
  ...
  function clearFocus(instance: string | Ref<QTRatingBar | undefined>) {
    if (isString(instance)) {
  ...
  function requestRootLayout(instance: string | Ref<QTRatingBar | undefined>) {
    if (isString(instance)) {
  ...
  function requestLayout(instance: string | Ref<QTRatingBar | undefined>) {
    if (isString(instance)) {
  ...
  function invalidate(instance: string | Ref<QTRatingBar | undefined>): void {
    if (isString(instance)) {
  ...
  function setStarMark(
    instance: string | Ref<QTRatingBar | undefined>,
    mark: string | number
  ): void {
    if (isString(instance)) {
      callUIFunction(instance, 'setStarMark', [mark])
    } else if (isRef(instance)) {
      instance.value!.setStarMark(mark)
    }
  }
