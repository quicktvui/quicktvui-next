...
export default defineComponent({
  ...
  setup() {
    ...
    function initESSeekBar() {
      ...
      seekBarRef.value?.setRange(0, maxProgress.value, 0)
      ...
      seekBarRef.value?.setThumbUrl('https://extcdn.hsrc.tv/exscreen/icon/4a772e37050d1c93affac41441983bc6.png')
      seekBarRef.value?.setThumbInactivatedUrl('https://extcdn.hsrc.tv/exscreen/icon/8804d235a23bcec668d2d2ac1f3c2937.png')
      ...
      progressTimer = setInterval(() => {
        ...
        if (progress.value > maxProgress.value) {
          seekBarRef.value?.setProgress(200)
          return
        }
