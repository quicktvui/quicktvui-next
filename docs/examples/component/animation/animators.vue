<template>
  <div class="es-sdk-root-css">
    ...
    <div
      ...
      style="height: 1080px"
    >
      <s-text-view text="Animators执行顺序" />
      <div class="es-sdk-content-row-css">
        <s-text-button
          text="playSequentially"
          @onButtonClicked="playSequentially"
        />
      ...
      <div class="es-sdk-content-divider-css" />
      <s-text-view
        text="以为Sequentially动画为例，操作Animators，首先点击'playSequentially'按钮，然后再执行以下按钮操作"
      />
      <div class="es-sdk-content-row-css">
        <s-text-button
          text="延迟2s开始Sequentially动画"
          @onButtonClicked="startAnimatorDelay"
        />
        <s-text-button
          text="反转Sequentially动画"
          @onButtonClicked="reverseAnimator"
        />
        <s-text-button
          text="暂停Sequentially动画"
          @onButtonClicked="pauseAnimator"
        />
        <s-text-button
          text="恢复Sequentially动画"
          @onButtonClicked="resumeAnimator"
        />
        <s-text-button
          text="取消Sequentially动画"
          @onButtonClicked="cancelAnimator"
        />
      </div>
      <div class="es-sdk-content-divider-css" />
...
export default defineComponent({
  ...
  setup() {
    ...
    function playTogether() {
      ...
      animationRef.value?.playTogether('TogetherAnimatorsId', [
        'AlphaAnimationId',
        'ScaleAnimationId',
        'RotationAnimationId',
        'TranslationAnimationId',
